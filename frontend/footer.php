...
<footer>
    <div id="foot-r2">
        <div class="footer">
            ...
            <div class="col-4">
                <div id="ico">
                    <a href="https://www.facebook.com/roll2gether/" class="icon-footer"><i class="fab fa-facebook-square fa-6x"></i></a>
                    <a href="https://twitter.com/together_roll" class="icon-footer"><i class="fab fa-twitter-square fa-6x"></i></a>
                    <a href="https://www.instagram.com/roll2gether/?hl=fr" class="icon-footer"><i class="fab fa-instagram fa-6x"></i></a>
                </div>
            </div>
            <div class="col-4">
